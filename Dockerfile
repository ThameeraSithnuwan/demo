# Use a single base image for both build and productiondfgd
FROM node:18-alpine AS build

# Create app directory
WORKDIR /usr/src/app

# Copy application dependency manifests to the container imagdfge.dfg
